...
export default function Button({ text, active, href }: ButtonProps) {
  ...
  return (
    <div
      className={`font-quicksand font-[500] flex items-center justify-center sm:ml-[2rem] ml-[0.9rem] sm:text-[1.6rem] text-[1.2rem] transition-all duration-[200ms] ${
        active
          ? 'cursor-default text-[#0f88dfd9] scale-[110%] transition-transform duration-200'
